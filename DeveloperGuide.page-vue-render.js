...
with(this){return _c('ul',[_c('li',[_v("Name: Ryan Tan")]),_v(" "),_c('li',[_v("Age 40")]),_v(" "),_c('li',[_v("Gender Male")]),_v(" "),_c('li',[_v("Job Role: Senior Librarian at a mid-sized public library")]),_v(" "),_c('li',[_v("Team Size: 5")]),_v(" "),_c('li',[_v("Patron Base: 500-1000 active library users")]),_v(" "),_c('li',[_v("Pain Points:\n"),_c('ul',[_c('li',[_v("Manual record-keeping is inefficient, relying on spreadsheets or paper logs for tracking borrowed books.")]),_v(" "),_c('li',[_v("Difficulties in monitoring overdue books, leading to unreturned books and revenue loss from unpaid fines.")]),_v(" "),_c('li',[_v("Limited visibility into user borrowing history, making it hard to provide services.")]),_v(" "),_c('li',[_v("Membership management is time-consuming, requiring frequent manual updates to renew, activate, or suspend accounts.")]),_v(" "),_c('li',[_v("No centralized way to track book availability, resulting in frequent patron inquiries.")])])]),_v(" "),_c('li',[_v("Technical Comfort\n"),_c('ul',[_c('li',[_v("Comfortable with using desktop applications.")]),_v(" "),_c('li',[_v("Familiar with basic command-line interfaces.")]),_v(" "),_c('li',[_v("No programming experience.")])])]),_v(" "),_c('li',[_v("Work Style\n"),_c('ul',[_c('li',[_v("Prefers a straightforward, easy-to-use system.")]),_v(" "),_c('li',[_v("Multitasks daily, handling book check-ins, assisting patrons, and managing overdue accounts.")]),_v(" "),_c('li',[_v("Needs quick access to information during peak hours when handling multiple requests.")])])]),_v(" "),_c('li',[_v("Goals\n"),_c('ul',[_c('li',[_v("Improve efficiency in managing books.")]),_v(" "),_c('li',[_v("Enhance the patron experience by quickly checking borrowing history and book availability.")]),_v(" "),_c('li',[_v("Streamline membership management by automating activations, renewals, and suspensions.")]),_v(" "),_c('li',[_v("Centralize book inventory and user records for a more organized, real-time system.")])])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("see usage instructions")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use the application")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("add a new library user")]),_v(" "),_c('td',[_v("register new users and allow them to borrow books")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("delete the details of a library users")]),_v(" "),_c('td',[_v("remove users that no longer use the library")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * ")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("check the membership status of a user")]),_v(" "),_c('td',[_v("cancel or renew memberships easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("issue a certain book to a certain user")]),_v(" "),_c('td',[_v("lend books to users and keep track of them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("edit/update details of a user")]),_v(" "),_c('td',[_v("keep the information accurate and up to date")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("mark that a user has returned a certain book")]),_v(" "),_c('td',[_v("keep track of returned books")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("let users extends their book return dates")]),_v(" "),_c('td',[_v("ensure users have the option of avoiding overdue fees")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("list users based on a filter")]),_v(" "),_c('td',[_v("look at users based on a certain criteria")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("check the due fees of a member")]),_v(" "),_c('td',[_v("ensure members pay the correct fee")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("see a list of overdue books and their corresponding users")]),_v(" "),_c('td',[_v("monitor the status of borrowed books")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("update book information")]),_v(" "),_c('td',[_v("ensure that book records remain accurate")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("librarian")]),_v(" "),_c('td',[_v("send automated reminders for overdue books or membership fees")]),_v(" "),_c('td',[_v("keep members updates on overdue books/fees")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a person with specific details")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the person to the list")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The provided details are incomplete or invalid.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. AddressBook shows an error message. Use case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. The person already exists in the AddressBook.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. AddressBook shows an error message. Use case resumes at step 1.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add a book")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a book with specific details")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds a book to the list")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The provided details are incomplete or invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The book already exists in the AddressBook.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Lend a book to a person")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list all persons")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows list of all persons")])]),_v(" "),_c('li',[_c('p',[_v("User requests to list all books")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows list of all books")])]),_v(" "),_c('li',[_c('p',[_v("User requests to lend a specific book to a specific person")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook marks book as borrowed")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook marks person as having borrowed the specific book")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("Should be able to hold up to 1000 persons and 10,000 book entries without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("Should be able to handle up to 1000 commands per hour without noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("Search operations (e.g., searching for books, members) should return results within 2 second for up to 1000 results.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The app should have an intuitive UI so that new librarians can start using it within 30 minutes.")]),_v(" "),_c('li',[_v("The system should provide clear error messages and tooltips to guide users.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Library Management System (LMS)")]),_v(": A software solution designed to help librarians manage book loans, overdue fines, and membership status efficiently.")]),_v(" "),_c('li',[_c('strong',[_v("Patron")]),_v(": A registered library user who can borrow books and use library services.")]),_v(" "),_c('li',[_c('strong',[_v("Membership Status")]),_v(": The current state of a patron's library account, which can be active, expired, or suspended.")]),_v(" "),_c('li',[_c('strong',[_v("Book Loan")]),_v(": The process of borrowing a book from the library for a specified duration.")]),_v(" "),_c('li',[_c('strong',[_v("Overdue Book")]),_v(": A book that has not been returned by its due date.")]),_v(" "),_c('li',[_c('strong',[_v("Overdue Fine")]),_v(": A penalty charged to a patron for not returning a book on time.")]),_v(" "),_c('li',[_c('strong',[_v("Check-in")]),_v(": The process of returning a borrowed book to the library.")]),_v(" "),_c('li',[_c('strong',[_v("Check-out")]),_v(": The process of lending a book to a patron.")]),_v(" "),_c('li',[_c('strong',[_v("Book Availability")]),_v(": The current status of a book, indicating whether it is available for borrowing or checked out by a patron.")]),_v(" "),_c('li',[_c('strong',[_v("Borrowing History")]),_v(": A record of all books a patron has borrowed in the past.")]),_v(" "),_c('li',[_c('strong',[_v("Renewal")]),_v(": Extending the borrowing period of a book before the due date.")]),_v(" "),_c('li',[_c('strong',[_v("Suspension")]),_v(": Temporarily restricting a patron’s ability to borrow books due to unpaid fines or violations of library policies.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Designing flexible command parsers for new command types.")]),_v(" "),_c('li',[_v("Ensuring data consistency across complex operations like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("issue")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("return")]),_v(".")]),_v(" "),_c('li',[_v("Handling JSON serialization of nested data.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"reused-components"}},[_v("Reused Components:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#reused-components","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("JSON storage structure from AB3, extended for new entity classes.")]),_v(" "),_c('li',[_v("UI base layout and controller patterns from AB3.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"effort-highlights"}},[_v("Effort Highlights:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#effort-highlights","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Book and user command logic: ~40%")]),_v(" "),_c('li',[_v("Command parsing: ~20%")]),_v(" "),_c('li',[_v("Testing: ~5%")]),_v(" "),_c('li',[_v("Model/storage integration: ~20%")]),_v(" "),_c('li',[_v("UI enhancements: ~15%")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 7 Apr 2025, 23:33:07 GMT+8]")])])])}
}];
